...
- [x] Rett Piper til norsk bokmål (`nb`) og test språkprofilen før trening.
- [x] Vis en presis løsning når Piper/eSpeak ikke kan åpne språkprofilen.
- [x] Bekreft nettsøk, kildeinnhenting og lokal lagring av ny kunnskap.
...
- [x] Selvlæring: oppdager kunnskapshull i egne svar, lærer om dem når maskinen er ledig, selvtester seg mot egen kunnskapsbase og oppsummerer ny kunnskap til varige notater.
