...
export const ROUTES = {
  ...
  ttsTrainingPreflight: "/tts/trening/preflight",
  ttsTrainingPytorch: "/tts/trening/pytorch",
  ttsTrainingResults: "/tts/trening/resultater",
  ttsTrainingNodes: "/tts/trening/noder",
  ttsTrainingDistribute: "/tts/trening/fordel",
  ...
  airllmStart: "/airllm/start",
  airllmStop: "/airllm/stopp",
  indexStatus: "/kunnskap/indeks",
  indexInstall: "/kunnskap/indeks/installer",
  ...
  memoryConsolidate: "/minne/konsolider",
  equipment: "/utstyr",
  equipmentFromScan: "/utstyr/fra-skann",
  reflection: "/refleksjon",
  reflectionOutcome: "/refleksjon/utfall",
  reflectionPatterns: "/refleksjon/monstre",
  plans: "/planer",
